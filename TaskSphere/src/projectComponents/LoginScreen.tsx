  ...
  return (
    <section className="w-screen h-screen bg-backgroundColor">
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="flex flex-row justify-center items-center mt-4 mb-6">
          <img src="/assets/images/logo.png" className=" w-5 h-5 px-1 my-5" />
        ...
        <div className="bg-white w-1/3 h-4/5  border-solid border border-formBorder rounded ">
          ...
          <form className=" flex flex-col justify-between   h-1/2 w-full  px-5 ">
            ...
            <input
              id="email"
              className="w-11/12 my-2 mx-4 px-2 py-2  border rounded border-solid border-inputBorderColor hover:shadow  outline-none text-xs focus:outline-none focus:border-focusBorder focus:ring-2 focus:ring-focusRing"
            ...
            <div className="relative ">
              <input
                id="password"
                className=" w-11/12 mb-4 mt-2 px-2 py-2 border rounded border-solid border-inputBorderColor hover:shadow outline-none focus:outline-none focus:border-focusBorder focus:ring-2 focus:ring-focusRing text-xs "
            ...
            <button
              type="button"
              //    onClick={}
              className=" w-11/12 rounded bg-primaryButtonColor border-primaryBotton border-opacity-5 hover:bg-primaryBotton text-white font-semibold mb-10 px-2 mx-4 mt-2 py-2 text-sm"
            >
              Log in
            </button>
          </form>
